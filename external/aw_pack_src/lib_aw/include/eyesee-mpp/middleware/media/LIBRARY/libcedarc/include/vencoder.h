...
#define DEFAULT_MOTION_SEARCH_HOR_REGION_NUM (30)
#define DEFAULT_MOTION_SEARCH_VER_REGION_NUM (17)
...
#define DEBUG_SHOW_ENCODE_TIME     0
...
typedef enum VENC_RESULT_TYPE {
    ...
    VENC_RESULT_DROP_FRAME_NO_INSERT_I = 12, //maybe overwrite, no insert I frame
	VENC_RESULT_TIMEOUT            = 13,
...
typedef enum
{
	...
	VencEvent_UpdateEncppSharpParam   = 6,
