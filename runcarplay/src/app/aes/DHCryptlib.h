...
BOOL JugeAuthKey( BYTE* pbAuthoKey , BYTE bLen);
extern int xcb_check_validation(char* path);//设置授权码，此处需要改下保存在设备
extern void openPort(int port);
extern void closePort(int port);
extern int aes_is_file_exist(char *path);
