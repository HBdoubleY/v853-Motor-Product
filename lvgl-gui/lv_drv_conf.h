...
#define LV_USE_SUNXIFB_G2D_FILL 	1//所有矩形填充操作（如清屏、单色背景）都会走G2D硬件加速
#define LV_USE_SUNXIFB_G2D_BLIT 	1//关闭意味着图像拷贝（如静态图片显示）仍用软件实现
#define LV_USE_SUNXIFB_G2D_BLEND 	0//关闭后所有透明度混合效果都会降级为CPU计算
#define LV_USE_SUNXIFB_G2D_SCALE 	1//则图像缩放需要软件处理
