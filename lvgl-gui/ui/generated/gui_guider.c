...
void init_scr_del_flag(lv_ui *ui)
{
	...
	ui->screen_del = true;
	ui->screen_DVR_del = true;
	ui->screen_SET_del = true;
	ui->screen_Tire_del = true;
	ui->screen_carPlay_del = true;
	ui->screen_androidAuto_del = true;
	ui->screen_DVR_SET_del = true;
	ui->screen_MediaLibrary_del = true;
	ui->screen_OTA_del = true;
	ui->screen_messageBox_del = true;
}
